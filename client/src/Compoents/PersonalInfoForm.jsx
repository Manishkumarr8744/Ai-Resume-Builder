        ...
        <label htmlFor="upload">
          {data?.image ? (
            <img
              ...
              alt="userProfile"
              className="w-16 h-16 rounded-full object-cover mt-6 ring ring-slate-300 hover:opacity-80"
            />
          ) : (
            <div className="inline-flex items-center gap-2 mt-5 text-slate-600 hover:text-slate-700 cursor-pointer">
              <User2Icon className="size-10 p-2.5 border rounded-full" />
              Upload User Image
            </div>
          )}
          <input
        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg  focus:ring focus:ring-blue-500 outline-none transition-colors text-sm"
