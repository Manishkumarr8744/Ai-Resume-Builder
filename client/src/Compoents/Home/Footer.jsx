...
const Footer = () => {
  return (
    <>
            ...
            <footer className="flex flex-col bg-gradient-to-r from-slate-400 via-orange-300 to-white items-center justify-around w-full py-16 text-sm text-gray-800/70">
                <div className="flex items-center gap-8">
                    <a href="#" className="font-medium text-gray-500 hover:text-orange-600 transition-all">
                        Home
                    </a>
                    <a href="#" className="font-medium text-gray-500 hover:text-orange-600 transition-all">
                        About
                ...
                <div className="flex items-center gap-4 mt-8 text-orange-500">
                ...
                <p className="mt-8 text-center">Copyright © 2025 | <a href="https://prebuiltui.com">AI Resume Builder</a>  | All rights reservered.</p>
            </footer>
        </>
  )
}
